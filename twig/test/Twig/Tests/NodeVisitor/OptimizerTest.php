...
class Twig_Tests_NodeVisitor_OptimizerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRenderParentBlockOptimizer()
    {
        ...
        $stream = $env->parse($env->tokenize(new Twig_Source('{% extends "foo" %}{% block php_templates %}{{ parent() }}{% endblock %}', 'index')));

        $node = $stream->getNode('blocks')->getNode('php_templates')->getNode(0)->getNode('body');
